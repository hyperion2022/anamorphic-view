...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            spadeProgressText = spadeUI.GetComponent<TextMeshProUGUI>();
            clubProgressText = clubUI.GetComponent<TextMeshProUGUI>();

            diamondPrizeText = diamondPrize.GetComponent<TextMeshProUGUI>();
        ...
        private void OnControllerColliderHit(ControllerColliderHit hit)
        {
            if (hit.gameObject.CompareTag("Diamond"))
            {
                ...
                diamondProgressText.text = "♦: " + diamondCounter + " / 13";
            ...
            else if (hit.gameObject.CompareTag("Heart"))
            {
                ...
                heartProgressText.text = "♥: " + heartCounter + " / 13";
                if (heartCounter == 13)
                {
            ...
            else if (hit.gameObject.CompareTag("Club"))
            {
                ...
                clubProgressText.text = "♣: " + clubCounter + " / 13";
                if (clubCounter == 13)
                {
